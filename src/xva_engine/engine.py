...
class XVAEngine:
    ...
    def run(self) -> dict:
        ...
        grid_days = build_simulation_grid(
            self.netting_set,
            dense_frequency_days=mc_cfg.dense_grid_frequency
        )
        ...
        bundle.save_array("V_ns_paths_sample", V_ns_paths[:, :min(100, mc_cfg.num_paths)])
        ...
        bundle.add_section("XVA Summary", f"CVA: {CVA:.6f}\nDVA: {DVA:.6f}\nFVA: {FVA:.6f}\nMVA: {MVA:.6f}\nKVA: {KVA:.6f}")
